...
pub trait ScalarValuable {
    ...
    fn scalar<'a>(&'a self, i: usize) -> ValueResult<PyroValue<'a>>;
}
...
trait ListValuable {
    unsafe fn clone_as_list<'a>(&self) -> ValueResult<Option<PrimitiveValueList<'a>>>;
}
...
mod tests {
    ...
    fn test_list_scalar() {
        ...
        assert_eq!(
            ...
            PyroValue::from(vec![PyroValue::I32(3), PyroValue::Null, PyroValue::I32(5)])
        );
    }
    ...
    fn test_dict_list_scalar() {
        ...
        assert_eq!(array.scalar(2).unwrap(), PyroValue::from(&[0i32, 1, 2][..]));
    }
}
